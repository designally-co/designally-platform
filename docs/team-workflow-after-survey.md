# What the team does after the answers arrive
...
- Is the severity right? The AI ranks by how much work a late reversal destroys; the person knows things the survey doesn't.
- Is anything missing that came up in the greeting meeting but never reached the form?
